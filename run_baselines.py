...
# -*- coding: utf-8 -*-
"""
Run RecBole built-in reference baselines on the SAME k=100 split / eval protocol
as step3 (IKGR), so we can position the IKGR numbers.
...
def main():
    ...
    out_path = "run/baselines_result.json"
    results = {}
